...
This repository contains the simulation models, design parameters, and measurement data for the antenna presented in our paper submitted to **IEEE Latin America Transactions**. The design utilizes high-order mode excitation combined with slot-loading techniques to achieve high gain within a compact footprint.
